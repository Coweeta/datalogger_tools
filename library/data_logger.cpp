...
bool DataLogger::is_event(uint8_t event)
{
    return ((1 << event) & _triggered_events) != 0;
}
...
// void DataLogger::log_float(double value)
// {
//
// }


void DataLogger::add_delimiters(uint8_t count)
{
